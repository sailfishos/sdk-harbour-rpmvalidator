...
Requires: qml(Amber.Web.Authorization)
...
Requires: qml(Qt.labs.folderlistmodel)
...
Requires: qml(QtWebSockets)
Requires: qml(Sailfish.Accounts)
Requires: qml(Sailfish.Bluetooth)
Requires: qml(Sailfish.Contacts)
Requires: qml(Sailfish.Crypto)
Requires: qml(Sailfish.Media)
Requires: qml(Sailfish.Pickers)
Requires: qml(Sailfish.Secrets)
Requires: qml(Sailfish.Share)
Requires: qml(Sailfish.Silica)
Requires: qml(Sailfish.Telephony)
Requires: qml(Sailfish.WebEngine)
Requires: qml(Sailfish.WebView)
Requires: qml(Sailfish.WebView.Controls)
Requires: qml(Sailfish.WebView.Pickers)
Requires: qml(Sailfish.WebView.Popups)
